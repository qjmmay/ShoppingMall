<template>
  <div>
    <Menu theme="primary" open-names="['0', '1', '2', '3', '4']" width="180px">
      ...
      <Submenu name="0">
        ...
        <router-link :to="{path: '/admin', query: {id: id}}">

          <MenuItem name="0-1">个人信息</MenuItem>
      ...
      <Submenu name="3">
        ...
        <router-link :to="{path: '/adminCommentList'}">
      ...
      <Submenu name="4">
        ...
        <router-link :to="{path: '/adminUserList'}">
